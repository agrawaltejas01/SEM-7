...
public class naive_bayes
{
	naive_bayes()
	{
		try
		{
			BufferedReader training = new BufferedReader(new FileReader("/home/test/BE/CL-7_practice/ML/Ass_7_Naive_Bayes_JAVA/WEKAirisTrain.arff"));
			BufferedReader testing = new BufferedReader(new FileReader("/home/test/BE/CL-7_practice/ML/Ass_7_Naive_Bayes_JAVA/WEKAirisTest.arff"));
			...
			for(int i=0; i<test.numClasses(); i++)
			{
				...
				System.out.printf("TPR = %.3f\n", result.truePositiveRate(i));
		...
		{
			System.err.println("Error msg in Classification : " + e.getMessage());
		}
	}
