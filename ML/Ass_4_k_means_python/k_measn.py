...
#import matplotlib inline # For display ploted graph
...
# Now dataset is
x.head()
    # Now apply k-means algorithm on iris dataset with 3 clusters as in iris dataset we have target value as
#species with 3 values as Setosa, Virginica, Versicolor
